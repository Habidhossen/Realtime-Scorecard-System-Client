...
const ScoreUpdateFormB = ({
  ...
  const onSubmit = (data) => {
    ...
    fetch(
      `https://realtime-cricket-scorecard-server.onrender.com/api/v1/update-cricket-score/${matchId}`,
      {
        method: "PATCH",
        headers: {
  ...
  const handleMatchFinishBtn = () => {
    ...
    // send data to the server
    fetch(
      `https://realtime-cricket-scorecard-server.onrender.com/api/v1/finish-cricket-match/${matchId}`,
      {
        method: "PATCH",
        headers: {
          "Content-type": "application/json",
    ...
    >
      ...
      bowlingTeam.runs > battingTeam.runs ? (
        ...
        <Button
          ...
          variant="contained"
          fullWidth
          sx={{ marginTop: "20px", background: "#b80f9d" }}
        >
